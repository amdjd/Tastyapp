 ...
 */
public class ResAdapter extends RecyclerView.Adapter<ResAdapter.MasonryView> {
    int layout;
    private Context mContext;
    private ArrayList<Restaurant> mItems = new ArrayList<Restaurant>();

    public ResAdapter(Context context, ArrayList<Restaurant> items) {
        mContext = context;
        mItems = items;
        layout =R.layout.grid_item;
    }
    public ResAdapter(Context context, ArrayList<Restaurant> items, int layout) {
        mContext = context;
        mItems = items;
        this.layout=layout;
    }
        ...
        public void onClick(View view) {
            ...
            if (position != RecyclerView.NO_POSITION) { // Check if an item was deleted, but the user clicked it before the UI removed it
                ...
                if(mContext instanceof MainActivity) {
                    ...
                    i.putExtra("user_id", activity.getUser_id());
                }
